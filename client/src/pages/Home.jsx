    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto scroll-smooth">
        ...
        <div className="text-blue-800 text-xs sm:text-lg">
          ...
          <br />
          With AYESTATE, finding your dream home is not just a possibility; it's
          a guarantee
          <br />
          Discover AYESTATE and embark on a journey to find the home of your
          dreams
          <br />
      ...
      <div className="box-border hover:box-content p-20 hover:transition-all cursor-pointer ">
        <img
          src="https://images.unsplash.com/photo-1560184897-ae75f418493e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80"
          alt="AYESTATE"
        />
      </div>
