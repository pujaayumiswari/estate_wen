          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="mb-4 block text-base font-semibold text-blue-800 ml-10">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-dark text-blue-800 sm:text-[40px] lg:text-[36px] xl:text-[40px] ml-5">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg  p-8 shadow-lg shadow-black-900 dark:bg-dark-2 sm:p-12">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-black bg-blue p-3 text-black transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
